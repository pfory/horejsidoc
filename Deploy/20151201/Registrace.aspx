...
<asp:SqlDataSource ID="DS_Zakaznik" runat="server" 
        ...
        InsertCommand="INSERT INTO T_Zakaznik(Prijmeni, Jmeno, Mail, Telefon, Mesto, Ulice, IC, Firma, VC, PSC, DIC, F_mesto, F_ulice, F_PSC, Heslo, Uzivatel, Obchodnik, Registrovan, Jazyk, Staty_ID, FirmaAdresa, ICOAdresa, DICAdresa) VALUES (@Prijmeni, @Jmeno, @Mail, @Telefon, @Mesto, @Ulice, @IC, @Firma, 0, @PSC, @DIC, @F_mesto, @F_ulice, @F_PSC, @Heslo, @Uzivatel, @Obchodnik, 1, @Jazyk, @Staty_ID, @FirmaAdresa, @ICOAdresa, @DICAdresa)" 
        SelectCommand="SELECT ID_zakaznik, RTRIM(Prijmeni) AS Prijmeni, RTRIM(Jmeno) AS Jmeno, RTRIM(Mail) AS Mail, Telefon, RTRIM(Mesto) AS Mesto, Ulice, IC, Firma, VC, PSC, DIC, RTRIM(F_mesto) AS F_mesto, F_ulice, F_PSC, Heslo, Uzivatel, Obchodnik, Registrovan, Staty_ID, FirmaAdresa, ICOAdresa, DICAdresa FROM T_Zakaznik WHERE (ID_zakaznik = @ID_zakaznik)" 
        
        UpdateCommand="UPDATE T_Zakaznik SET Prijmeni = @Prijmeni, Jmeno = @Jmeno, Mail = @Mail, Telefon = @Telefon, Mesto = @Mesto, Ulice = @Ulice, IC = @IC, Firma = @Firma, PSC = @PSC, DIC = @DIC, F_mesto = @F_mesto, F_ulice = @F_ulice, F_PSC = @F_PSC, Staty_ID=@Staty_ID, FirmaAdresa=@FirmaAdresa, ICOAdresa=@ICOAdresa, DICAdresa=@DICAdresa WHERE (ID_zakaznik = @ID_zakaznik)" 
...
<div class="registrace">    
    <asp:FormView ID="FRV_zakaznik" runat="server" DataSourceID="DS_Zakaznik" 
            ...
            <table>
                ...
                <tr>
                    <td style="text-align: right; " >
                        <asp:Literal ID="Literal215" runat="server" Text="<%$ Resources: FRV_row1%>" /></td>
                    <td>
                        <asp:TextBox ID="txb_insertPrijmeni" runat="server" 
                            Text='<%# Bind("Prijmeni") %>' MaxLength="200"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txb_insertJmeno" runat="server" 
                            Text='<%# Bind("Jmeno") %>' MaxLength="50"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2" style="cursor:pointer">
                        ...
                        <td align="center">
                            <asp:TextBox ID="txb_insertFirma" runat="server" Text='<%# Bind("Firma") %>' 
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:TextBox ID="txb_insertICO" runat="server" Text='<%# Bind("IC") %>' 
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:TextBox ID="txb_insertDIC" runat="server" Text='<%# Bind("DIC") %>' 
                                        MaxLength="15"></asp:TextBox>
                                </td>
                            </tr>
                            <%End If%>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Literal ID="Literal30" runat="server" Text="<%$ Resources:FRV_row15%>" />
                    </td>
                </tr>

                <tr>
                    <td style="text-align: right; " >
                       <asp:Literal ID="Literal24" runat="server" Text="<%$ Resources: FRV_row91%>" /></td>
                    <td>
                        <asp:TextBox ID="txb_Firma" runat="server" Text='<%# Bind("FirmaAdresa") %>' 
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Literal ID="Literal31" runat="server" Text="<%$ Resources:FRV_row16%>" />
                    </td>
                </tr>

                <tr>
                    <td style="text-align: right; " >
                       <asp:Literal ID="Literal28" runat="server" Text="<%$ Resources: FRV_row92%>" /></td>
                    <td>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("ICOAdresa") %>' 
                            MaxLength="10"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; " >
                       <asp:Literal ID="Literal29" runat="server" Text="<%$ Resources: FRV_row93%>" /></td>
                    <td>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("DICAdresa") %>' 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="rval_mesto" runat="server" 
                            ...
                            ErrorMessage="<%$ Resources: VAL3%>" ValidationExpression="\D{2,}\s*\d*\D*" 
                            ValidationGroup="valInsert"></asp:RegularExpressionValidator>
                ...
                <tr>
                    <td style="text-align: right; " >
                        <asp:Literal ID="Literal14" runat="server" Text="<%$ Resources: FRV_row10%>" ></asp:Literal>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txb_insertFUlice" runat="server" 
                             Text='<%# Bind("F_ulice") %>' MaxLength="200"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right">
                ...
                <tr>
                    <td style="text-align: right; " >
                        <asp:Literal ID="Literal20" runat="server" Text="<%$ Resources: FRV_row11%>" />
                        <td>
                            <asp:TextBox ID="txb_insertUziv" runat="server" Text='<%# Bind("Uzivatel") %>' 
                                Width="155px" MaxLength="250"></asp:TextBox>
                            <asp:Label ID="Label11" runat="server" ForeColor="Red" Text="*"></asp:Label>
                            <asp:RequiredFieldValidator ID="val_uzivatel" runat="server" 
                                ControlToValidate="txb_insertUziv" Display="None" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txb_insertHeslo" runat="server" Text='<%# Bind("Heslo") %>' 
                            TextMode="Password" Width="155px" MaxLength="50"></asp:TextBox>
                ...
                <tr>
                    <td align="center" colspan="2" >
                        <asp:Label ID="Label13" runat="server" ForeColor="Red" Text="<%$ Resources: PovinnePole%>"></asp:Label>
                    </td>
                </tr>
                <tr><td><td></td></td></tr>
                <tr>
        ...
        <table class="obsah" >
                ...
                <tr>
                    <td style="text-align: right" >
                       <asp:Literal ID="Literal25" runat="server" Text="<%$ Resources: FRV_row91%>" /></td>
                    <td>
                        <asp:TextBox ID="txbFirmaAdresa" runat="server" 
                            Text='<%# Bind("FirmaAdresa") %>' MaxLength="100"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <asp:Literal ID="Literal32" runat="server" Text="<%$ Resources:FRV_row16%>" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" >
                       <asp:Literal ID="Literal26" runat="server" Text="<%$ Resources: FRV_row92%>" /></td>
                    <td>
                        <asp:TextBox ID="txbICOAdresa" runat="server" Text='<%# Bind("ICOAdresa") %>' 
                            MaxLength="10"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" >
                       <asp:Literal ID="Literal27" runat="server" Text="<%$ Resources: FRV_row93%>" /></td>
                    <td>
                        <asp:TextBox ID="txbDICAdresa" runat="server" Text='<%# Bind("DICAdresa") %>' 
                            MaxLength="12"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: right; " >
                        <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources: FRV_row3%>" /></td>
                    <td>
                        <asp:TextBox ID="txb_updateMail" runat="server" Text='<%# Bind("Mail") %>' 
                            MaxLength="300"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2" style="text-align: left; ">
                        ...
                        <tr><td style="text-align: right"><asp:Literal ID="Literal8" runat="server" Text="<%$ Resources: FRV_row5%>" /></td>
                        <td align="center">
                            <asp:TextBox ID="txb_updateFirma" runat="server" Text='<%# Bind("Firma") %>' 
                                MaxLength="200"></asp:TextBox></td>
                        </tr>
                            <tr>
                                <td style="text-align: right">
                                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources: FRV_row6%>" /></td>
                                <td align="center">
                                    <asp:TextBox ID="txb_updateICO" runat="server" Text='<%# Bind("IC") %>' 
                                        MaxLength="15"></asp:TextBox>
                                </td>
                            </tr>
                            <%If CultureInfo.CurrentCulture.ToString = "cs-CZ" Then%>
                            <tr>
                                <td style="text-align: right">
                                    <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources: FRV_row7%>" /></td>
                                <td align="center">
                                    <asp:TextBox ID="txb_updateDIC" runat="server" Text='<%# Bind("DIC") %>' 
                                        MaxLength="15"></asp:TextBox>
                                </td>
                            </tr>
                            <%End If%>
                ...
                <tr>
                    <td colspan="2" align="center" 
                        ...
                        ><asp:Literal ID="Literal11" runat="server" Text="<%$ Resources: FRV_title3%>" />
                    </td>
                    <td>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" >
                       <asp:Literal ID="Literal12" runat="server" Text="<%$ Resources: FRV_row8%>" /></td>
                    <td>
                        <asp:TextBox ID="txb_updateMesto" runat="server" Text='<%# Bind("Mesto") %>' 
                            MaxLength="200"></asp:TextBox>
                ...
                <tr>
                    <td style="text-align: right" >
                        <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources: FRV_row9%>" /></td>
                    <td>
                        <asp:TextBox ID="txb_updateUlice" runat="server" Text='<%# Bind("Ulice") %>' 
                            MaxLength="200"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txb_updatePSC" runat="server" Text='<%# Bind("PSC") %>' 
                            MaxLength="50"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txb_updateFMesto" runat="server" Text='<%# Bind("F_mesto") %>' 
                            MaxLength="200"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="rval_Fmesto" runat="server" 
                ...
                <tr>
                    <td style="text-align: right">
                        <asp:Literal ID="Literal16" runat="server" Text="<%$ Resources: FRV_row10%>" /></td>
                    <td>
                        <asp:TextBox ID="txb_updateFPSC" runat="server" Text='<%# Bind("F_PSC") %>' 
                            MaxLength="50"></asp:TextBox>
