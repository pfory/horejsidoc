...
<asp:Content ID="Content1" ContentPlaceHolderID="Hlavni" runat="Server">
    <script type='text/javascript' language='javascript'>
        function cbSouhlas(ischecked) {
            if (ischecked) {
                document.getElementById('ctl00_Hlavni_FRV_zakaznik_labelSouhlas').className = 'hiddenPrvek';
                if (document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_ObjednatBezReg')!=null) {
                    document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_ObjednatBezReg').className = 'button';
                }
                if (document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_Objednat')!=null) {
                    document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_Objednat').className = 'button';
                }
            } else {
                document.getElementById('ctl00_Hlavni_FRV_zakaznik_labelSouhlas').className = 'visible';
                if (document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_ObjednatBezReg') != null) {
                    document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_ObjednatBezReg').className = 'hiddenPrvek';
                }
                if (document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_Objednat')!=null) {
                    document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_Objednat').className = 'hiddenPrvek';
                }
            }        
        }
        //function cbLoad() {
        //    if (document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_ObjednatBezReg') != null) {
        //        if (document.getElementById('ctl00_Hlavni_FRV_zakaznik_cbSouhlasOP').checked) {
        //            document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_ObjednatBezReg').className = 'button';
        //            document.getElementById('ctl00_Hlavni_FRV_zakaznik_labelSouhlas').className = 'hiddenPrvek';
        //        } else {
        //            document.getElementById('ctl00_Hlavni_FRV_zakaznik_BTN_ObjednatBezReg').className = 'hiddenPrvek';
    ...
    <h1>
     ...
     <%If isUlozenyKosikEmpty = False Then%>

    <div class="centr nazev">
      <asp:Localize ID="Localize5" runat="server" Text='<% $ Resources: obsahKosikuUlozeny%>'></asp:Localize>
      <asp:Button ID="btn_Load" CssClass="button" Visible="True" runat="server" Text="<%$ Resources: nactiKosik%>" ToolTip="<%$ Resources: nactiKosikToolTip%>" />
      <asp:Button ID="btn_Smaz" CssClass="button" Visible="True" runat="server" Text="<%$ Resources: smazKosik%>" ToolTip="<%$ Resources: smazKosikToolTip%>" />
    </div>

    <div style="float:left;">
    <asp:GridView ID="GridView1" runat="server" DataSourceID="DS_Objednavka_Ulozena" AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="1px">
      <Columns>
        <asp:BoundField DataField="ID_objcislo" HeaderText="<%$ Resources: RPT_VybraneZbozi_Col1%>" />
        <asp:HyperLinkField DataTextField="Text" DataNavigateUrlFormatString="~/Pages/DetailProdukt.aspx?objcislo={0}" HeaderText="<%$ Resources: RPT_VybraneZbozi_Col2%>" DataNavigateUrlFields="ID_objcislo" />
        <asp:BoundField DataField="Mnozstvi" HeaderText="<%$ Resources: RPT_VybraneZbozi_Col3%>" />
        <asp:BoundField DataField="Jednotka" HeaderText="<%$ Resources: mernaJednotka%>" />
      </Columns>
      <HeaderStyle BackColor="LightGray" Font-Bold="True" ForeColor="Black" Font-Size="X-Small" Font-Italic="true" />
    </asp:GridView>
    <br />
    ...
    <div class="centr nazev">
        ...
        <asp:Button ID="btn_Save" CssClass="button" Visible="True" runat="server" Text="<%$ Resources: ulozKosik%>" ToolTip="<%$ Resources: ulozKosikToolTip%>" />
    </div>
            <div class="centr">
            ...
            <asp:Repeater ID="RPT_VybraneZbozi" runat="server" >
                <HeaderTemplate>
                    <table border="1px" width=600px style="border-collapse: collapse; margin-right: auto; margin-left: auto">
                        <tr style="font-size: x-small; font-style: italic; color: black; font-weight: bold; background-color: lightgray;" align="center">
                            <td>
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                          <asp:Label  ID="objcislo" runat="server" Text="<%#CType(Container.DataItem, VybraneZbozi).objcislo%>"></asp:Label>
                        </td>
                        <%If CultureInfo.CurrentCulture.ToString = "cs-CZ" Then%>
                        <td>
                            <a href="DetailProdukt.aspx?objcislo=<%#CType(Container.DataItem, VybraneZbozi).objcislo%>">
                        ...
                        <td>
                            <table width="100%">
                                <tr>
                                    <td rowspan="2">
                                      <asp:Label ID="mnozstvi" runat="server" Text="<%#CType(Container.DataItem, VybraneZbozi).mnozstvi%>"> </asp:Label>
                                        <%#CType(Container.DataItem, VybraneZbozi).jednotka%>
                                    </td>
                                    <td valign="bottom">
                ...
                <FooterTemplate>
                    <tr>
                        ...
                        <td>
                            <%# Format(obj.sectiPolozky(CType(Session("zvoleneZbozi"), ArrayList), CInt(RBL_odber.SelectedValue), prihlasen.VC, "cs-CZ", prihlasen.VC), "#,0 Kè")%>
                            <%If typZakaznika.cizinec Then%>
                                <br />/<%# Format(obj.sectiPolozky(CType(Session("zvoleneZbozi"), ArrayList), CInt(RBL_odber.SelectedValue), prihlasen.VC, "EUR", prihlasen.VC), "#,0.00 €")%><%End If%></td>
                    </tr>
                    </table>
                </FooterTemplate>
            </asp:Repeater>
    ...
    <asp:SqlDataSource ID="DS_Objednavka_Ulozena" runat="server"  ConnectionString="<%$ ConnectionStrings:DataHorejsi %>"
        SelectCommand="SELECT T_Objednavky_Ulozene.ID_objcislo, CASE WHEN @lang='cs-CZ' then T_Produkt.Text_CZ else T_Produkt.Text_EN END Text, T_Objednavky_Ulozene.Mnozstvi Mnozstvi, T_Objednavky_Ulozene.ID_zakaznik ID_Zakaznik, T_Produkt.Jednotka Jednotka FROM T_Objednavky_Ulozene left outer join T_Produkt ON T_Produkt.ID_objcislo=T_Objednavky_Ulozene.ID_objcislo WHERE ([ID_zakaznik] = @ID_zakaznik) ORDER BY 2"
        DeleteCommand="DELETE FROM T_Objednavky_Ulozene WHERE ID_zakaznik=@ID_zakaznik"
        InsertCommand="INSERT INTO T_Objednavky_Ulozene (ID_objcislo, Mnozstvi, ID_Zakaznik) VALUES (@ID_objcislo, @Mnozstvi, @ID_Zakaznik)"
        UpdateCommand="UPDATE T_Objednavky_Ulozene SET Mnozstvi=@Mnozstvi WHERE ID_objcislo=@ID_objcislo">
        <SelectParameters>
            <asp:Parameter Name="ID_zakaznik" />
      ...
      <InsertParameters>
          <asp:Parameter Name="ID_objcislo" Type="Int32" />
          <asp:Parameter Name="Mnozstvi"    Type="Int32" />
          <asp:Parameter Name="ID_Zakaznik" Type="Int32" />
      </InsertParameters>
      <UpdateParameters>
          <asp:Parameter Name="ID_objcislo" Type="Int32" />
            ...
            <asp:FormView ID="FRV_zakaznik" runat="server" DataSourceID="DS_Zakaznik" Width="100%"
                ...
                <InsertItemTemplate>
                    <table style="margin-right: auto; margin-left: auto" width="100%">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:FRV_row14 %>" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Literal ID="Literal39" runat="server" Text="<%$ Resources:FRV_row15 %>" />
                            </td>
                        </tr>
                        <tr>
                        <td  style="text-align: right">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="rval_mesto" runat="server" 
                                    ControlToValidate="txb_insertMesto" Display="none" 
                                    ErrorMessage="<%$ Resources: VAL21%>" ValidationExpression="\D{2,}\s*\d*\D*" 
                                    ValidationGroup="valInsert"></asp:RegularExpressionValidator>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:CheckBox ID="cbSouhlasOP" Text="<%$ Resources: FRV_souhlasOP%>" runat="server" onclick="cbSouhlas(this.checked);"/>
                                <a href="ObchPodminky.aspx" target="_blank"><asp:Literal runat="server" Text="<%$ Resources: FRV_souhlasOPodkaz%>" /></a>
                            </td>
                        </tr>

                        <tr>
                            <td colspan="2" align="center">
                                <asp:Label ID="labelSouhlas" Text="<%$ Resources: alertSouhlasOPText%>"  runat="server" />
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <asp:Button ID="BTN_ObjednatBezReg" runat="server" CommandName="Insert" CssClass="button" OnClick="BTN_Objednat_Click"
                                    Text="<%$ Resources: BTN_potvrdit%>" ValidationGroup="valInsert" />
                                <br />

                              <cc1:ConfirmButtonExtender  ID="ConfirmButtonExtender1" runat="server" DisplayModalPopupID="mpe" TargetControlID="BTN_ObjednatBezReg">
                                </cc1:ConfirmButtonExtender>

                                <cc1:ModalPopupExtender ID="mpe" runat="server" PopupControlID="pnlPopup" TargetControlID="BTN_ObjednatBezReg" OkControlID = "btnYes"
                                    DynamicServicePath="" Enabled="True" 
                                    CancelControlID="btnNo" BackgroundCssClass="ModalPopupBG">
                                ...
                                <asp:Panel ID="pnlPopup" runat="server">
                                    <div class="popup_Container">
                                        <div class="popup_Titlebar" id="PopupHeader">
                                            <asp:Label runat="server" Text="<%$ Resources: BTN_potvrdit%>"></asp:Label>
                                        </div>
                                        <div class="popup_Body">
                                            <asp:Label runat="server" Text="<%$ Resources: CBE_potvrdit%>"></asp:Label>
                                            <div class="popup_Buttons">
                                                <br />
                                                <asp:Button ID="btnYes" runat="server" CssClass="button" Text="<%$ Resources: BTN_potvrditYes%>" />
                                                <asp:Button ID="btnNo" runat="server" CssClass="button" Text="<%$ Resources: BTN_potvrditNo%>" />
                                            </div>
                                        </div>
                                    </div>
                                </asp:Panel>
                ...
                <ItemTemplate>
                    <table style="margin-right: auto; margin-left: auto" width="100%">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="BTN_Objednat" runat="server" CssClass="button" Text="<%$ Resources: BTN_potvrdit%>"  OnClick="BTN_Objednat_Click"/>
                                <br />
                                <cc1:ConfirmButtonExtender  ID="ConfirmButtonExtender1" runat="server" DisplayModalPopupID="mpe" TargetControlID="BTN_Objednat">
                                </cc1:ConfirmButtonExtender>

                                <cc1:ModalPopupExtender ID="mpe" runat="server" PopupControlID="pnlPopup" TargetControlID="BTN_Objednat" OkControlID = "btnYes"
                                    DynamicServicePath="" Enabled="True" 
                                    CancelControlID="btnNo" BackgroundCssClass="ModalPopupBG">
                                </cc1:ModalPopupExtender>
