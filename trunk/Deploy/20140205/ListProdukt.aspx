...
<asp:Content ID="Content1" ContentPlaceHolderID="Hlavni" runat="Server">
    ...
    <h1>
        <asp:Label ID="LBL_Cesta" runat="server"></asp:Label></h1>
    ...
    <div class="centr">
        ...
        <%End If%>
                        ...
                        <td>
                            <div class="produkt2">
                                <div class="nazev">
                                    ...
                                    <asp:Label ID="LBL_poznamka1" runat="server" CssClass="poznamka" Text='<%# IIf (DataBinder.Eval(Container.DataItem, "Poznamka")=" ","",DataBinder.Eval(Container.DataItem, "Poznamka"))%>'></asp:Label>
                                </div>
                                <div class="nahled">
                                ...
                                <div class="produktinfo">
                                    ...
                                    <asp:TextBox ID="TXB_kusu1" CssClass="pocet" runat="server" MaxLength="3" Text='<%# Bind("Min_ks") %>'></asp:TextBox>
            ...
            <div class="strankovani">
                <div class="strankovaninapln">
                    <asp:Label ID="LBL_page" runat="server" Text="<%$ Resources: LBL_page %>"></asp:Label>
                    <asp:DataPager ID="DataPager1" PagedControlID="LSV_Produkty" PageSize="10" runat="server">
                        <Fields>
