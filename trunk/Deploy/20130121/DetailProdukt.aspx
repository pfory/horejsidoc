...
<asp:Content ID="Content1" ContentPlaceHolderID="Hlavni" Runat="Server">
    ...
    <h1>
        <%-- %><asp:HyperLink ID="HL_Produkt" CssClass="linkZpet"  runat="server" NavigateUrl="" meta:resourcekey="HL_Produkt" Text=""></asp:HyperLink>--%>
    <asp:LinkButton id="HL_Produkt" CssClass="linkZpet" runat="server" meta:resourcekey="HL_Produkt" Text="" OnClientClick="JavaScript:window.history.back(1);return false;"></asp:LinkButton>
    </h1>
   ...
   <div class="seznamproduktu2">
    <asp:ListView ID="dls_detailProduktu" runat="server" DataSourceID="DS_Produkt" >
      ...
      <%If CultureInfo.CurrentCulture.ToString = "cs-CZ" Then%>
        ...
        <EmptyDataTemplate>
            <asp:Label style="color:Red;font-size:15px;text-align:center;display:block;" Text="<%$ Resources: Error %>" runat="server" />
        </EmptyDataTemplate>
    </asp:ListView>
    <div style="margin:auto; margin-top:23px; text-align: center; float:left; width:100%">
